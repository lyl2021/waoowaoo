...
- 资产中心页面布局重构：从滚动布局迁移到固定头部布局，提升界面稳定性
- 文件夹管理系统：保持完整的文件夹导航、创建、编辑和删除功能
...
- **布局问题**：资产中心页面滚动异常：确认固定头部布局的 CSS 样式和高度计算
...
- **布局升级**：资产中心页面采用固定头部布局，增强界面稳定性与专业感
